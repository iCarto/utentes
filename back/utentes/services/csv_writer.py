...
def write_tmp_file_from_records(_sheets: dict) -> BinaryIO:
    ...
    return write_tmp_file_from_dataframes(sheets)
...
def write_tmp_file_from_dataframes(sheets: Dict) -> BinaryIO:
...
def write_file_from_dataframes(sheets: dict, file: BinaryIO) -> None:
