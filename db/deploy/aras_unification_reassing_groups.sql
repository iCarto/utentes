-- Deploy utentes:aras_unification_reassing_groups to pg

BEGIN;

DELETE FROM domains.groups WHERE key IS NULL AND ordering = 0;


-- Administrador ordering 1
